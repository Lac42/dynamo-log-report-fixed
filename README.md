...
Parse an Apache-style access log into a small JSON summary report. This is a repaired
version of a deliberately broken TB2 task, fixed into correct Harbor format.
